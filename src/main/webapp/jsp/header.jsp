...
<body>
	<div class="container">
		...
		<div align="center">
			...
			<ul>
				<li id="liTag"><a class = "headerHyperLink" href="showPetitions.htm">Home</a></li>
				<li id="liTag"><a class = "headerHyperLink" href="createPetition.htm">Create Petition</a></li>
				<li id="liTag"><a class = "headerHyperLink" href="showSearchPetition.htm">Search Petition</a></li>
			</ul>
